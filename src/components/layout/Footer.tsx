        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-8 mb-20">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4 text-[14px] opacity-80 font-medium text-[#86868b]">
              ...
              <li><a href="#" className="hover:text-black transition-colors">Learning Centers</a></li>
              <li><a href="#" className="hover:text-black transition-colors">Programs</a></li>
              <li><a href="#" className="hover:text-black transition-colors">Campus Life</a></li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4 text-[14px] opacity-80 font-medium text-[#86868b]">
              <li><a href="#" className="hover:text-black transition-colors">Admissions Process</a></li>
              <li><a href="#" className="hover:text-black transition-colors">Age Criteria</a></li>
              <li><a href="#" className="hover:text-black transition-colors">Fee Structure</a></li>
              <li><a href="#" className="hover:text-black transition-colors">Scholarships</a></li>
              <li><a href="#" className="hover:text-black transition-colors">FAQs</a></li>
              <li><a href="#" className="hover:text-black transition-colors">Book a Tour</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4 text-[14px] opacity-80 font-medium text-[#86868b]">
              <li><a href="#" className="hover:text-black transition-colors">Parent Partnership</a></li>
              <li><a href="#" className="hover:text-black transition-colors">Mentor Development</a></li>
              <li><a href="#" className="hover:text-black transition-colors">Blogs & Insights</a></li>
              <li><a href="#" className="hover:text-black transition-colors">Events</a></li>
              <li><a href="#" className="hover:text-black transition-colors">Handbook</a></li>
              <li><a href="#" className="hover:text-black transition-colors">School Policies</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-5 text-[14px] opacity-80 font-medium text-[#86868b]">
              ...
              <li><a href="mailto:hello@genbright.in" className="hover:text-black transition-colors">hello@genbright.in</a></li>
            </ul>
          </div>
